...
export default function ActivityForm({
  ...
  // Nueva variable de estado para el modo de prueba
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const taskData: TaskInput = {
        ...
        // Si está en modo de prueba, usar 5 segundos (0.08 minutos), si no, usar la duración seleccionada
        durationMinutes: isTestMode ? 0.1 : duration,
        ...
        >
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              {/* Slider disabled when in test mode */}
              <input
                type="range"
                min="10"
                max="120"
                ...
                className={`w-full accent-indigo-500 h-2 mt-2 ${
                  isTestMode ? "opacity-50" : ""
                }`}
                disabled={isTestMode}
              />

              {/* Test mode checkbox */}
              <div className="flex items-center gap-2.5 mt-3 pt-1 border-t border-slate-700">
                <input
                  type="checkbox"
                ...
                <label
                  htmlFor="testMode"
                  className="text-sm text-purple-300 font-medium flex items-center gap-1.5"
                >
            ...
            <div className="flex gap-3 pt-4">
              ...
              <button
                ...
                } transition-colors rounded-lg disabled:opacity-50 text-base font-medium`}
              >
                {isSubmitting
                  ? "Creating..."
                  : isTestMode
